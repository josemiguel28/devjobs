<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="flex flex-col bg-white rounded-2xl shadow-sm p-6 mb-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 max-w-2xl line-clamp-2">{{ $vacante->titulo }}</h1>
        ...
        <div class="flex justify-end p-4 space-x-3">
            <x-primary-button
                ...
                class="flex items-center gap-2 bg-yellow-500 focus:ring-offset-2 transition-all duration-200">
